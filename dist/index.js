...
const axios_1 = __importDefault(__nccwpck_require__(8777));
class ApiClient {
    constructor(config) {
...
const form_data_1 = __importDefault(__nccwpck_require__(4668));
...
class BrOperations {
    ...
    async uploadDistribution(distributionPath, accessToken) {
        ...
        const response = await this.apiClient.post(uploadDistributionUrl, formData, config);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const BrOperations_1 = __nccwpck_require__(8321);
const core = __importStar(__nccwpck_require__(5674));
const ApiClient_1 = __nccwpck_require__(3330);
...
async function uploadDistribution() {
    try {
        const brcStack = core.getInput('username', { required: true });
...
const utils_1 = __nccwpck_require__(2501);
/**
 * Commands
 *
 * Command Format:
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const command_1 = __nccwpck_require__(3151);
const file_command_1 = __nccwpck_require__(2744);
const utils_1 = __nccwpck_require__(2501);
const os = __importStar(__nccwpck_require__(2087));
...
module.exports =
{
  parallel      : __nccwpck_require__(9413),
  serial        : __nccwpck_require__(5816),
  serialOrdered : __nccwpck_require__(7099)
};
...
var defer = __nccwpck_require__(1455);
...
var async = __nccwpck_require__(1926)
  , abort = __nccwpck_require__(4343)
  ;
...
var abort = __nccwpck_require__(4343)
  , async = __nccwpck_require__(1926)
  ;
...
var iterate    = __nccwpck_require__(6461)
  , initState  = __nccwpck_require__(7824)
  , terminator = __nccwpck_require__(9137)
  ;
...
var serialOrdered = __nccwpck_require__(7099);
...
var utils = __nccwpck_require__(3202);
var settle = __nccwpck_require__(8574);
var buildFullPath = __nccwpck_require__(895);
var buildURL = __nccwpck_require__(4603);
var http = __nccwpck_require__(8605);
var https = __nccwpck_require__(7211);
var httpFollow = __nccwpck_require__(1064).http;
var httpsFollow = __nccwpck_require__(1064).https;
var url = __nccwpck_require__(8835);
var zlib = __nccwpck_require__(8761);
var pkg = __nccwpck_require__(696);
var createError = __nccwpck_require__(3126);
var enhanceError = __nccwpck_require__(9047);
...
var utils = __nccwpck_require__(3202);
var settle = __nccwpck_require__(8574);
var cookies = __nccwpck_require__(2466);
var buildURL = __nccwpck_require__(4603);
var buildFullPath = __nccwpck_require__(895);
var parseHeaders = __nccwpck_require__(729);
var isURLSameOrigin = __nccwpck_require__(4988);
var createError = __nccwpck_require__(3126);
...
var utils = __nccwpck_require__(3202);
var bind = __nccwpck_require__(2555);
var Axios = __nccwpck_require__(6326);
var mergeConfig = __nccwpck_require__(834);
var defaults = __nccwpck_require__(8591);
...
axios.Cancel = __nccwpck_require__(3680);
axios.CancelToken = __nccwpck_require__(2443);
axios.isCancel = __nccwpck_require__(5020);

// Expose all/spread
axios.all = function all(promises) {
  return Promise.all(promises);
};
axios.spread = __nccwpck_require__(4510);

// Expose isAxiosError
axios.isAxiosError = __nccwpck_require__(2727);
...
var Cancel = __nccwpck_require__(3680);
...
var utils = __nccwpck_require__(3202);
var buildURL = __nccwpck_require__(4603);
var InterceptorManager = __nccwpck_require__(6530);
var dispatchRequest = __nccwpck_require__(3264);
var mergeConfig = __nccwpck_require__(834);
...
var isAbsoluteURL = __nccwpck_require__(9997);
var combineURLs = __nccwpck_require__(1421);
...
var utils = __nccwpck_require__(3202);
var transformData = __nccwpck_require__(9358);
var isCancel = __nccwpck_require__(5020);
var defaults = __nccwpck_require__(8591);
...
var utils = __nccwpck_require__(3202);
var normalizeHeaderName = __nccwpck_require__(5355);
...
function getDefaultAdapter() {
  ...
  if (typeof XMLHttpRequest !== 'undefined') {
    ...
    adapter = __nccwpck_require__(5783);
  } else if (typeof process !== 'undefined' && Object.prototype.toString.call(process) === '[object process]') {
    // For node use HTTP adapter
    adapter = __nccwpck_require__(4294);
  }
  return adapter;
}
...
var DelayedStream = __nccwpck_require__(3655);
...
var CombinedStream = __nccwpck_require__(2033);
var util = __nccwpck_require__(1669);
...
var mime = __nccwpck_require__(2667);
var asynckit = __nccwpck_require__(9662);
var populate = __nccwpck_require__(3713);
...
var db = __nccwpck_require__(5262)
...
/******/ 	return __nccwpck_require__(9072);
/******/ })()
;